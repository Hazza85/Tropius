...
EntityPositioner.prototype.placeDown = function () {
    this._hasPositioned = true;
    this.targetEntity.setLocalPosition(this.pointerPreviewEntity.getLocalPosition());
    this._onTracking();
}

EntityPositioner.prototype._onArHit = function (position, rotation) { //Suitable plane was found
